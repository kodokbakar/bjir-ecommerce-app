        ...
        <div style={{ display: "flex", minHeight: "100vh", background: "#f8f6f4" }}>
            ...
            <aside style={{
                ...
                <div style={{
                    ...
                    <div style={{ flexShrink: 0, width: 32, height: 32, background: C.primary, borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center" }}>
                    ...
                    {!isCollapsed && (
                        <span style={{ fontSize: 16, fontWeight: 600, color: C.textDark, whiteSpace: "nowrap" }}>
                            Bjir-Ecommerce
                        </span>
                    )}
                </div>

                <nav style={{ flex: 1, padding: isCollapsed ? "20px 8px" : "20px 16px", display: "flex", flexDirection: "column", gap: 8, transition: "padding 0.2s" }}>
                    {NAV_MENU.map((menu) => {
