...
function CategoryProducts() {
            ...
            <section className="category-products-page">
                <div className="products-panel-state" role="alert">
                    <div>
                        ...
                        <p>This category link does not exist anymore.</p>
    ...
    return (
        <section className="category-products-page" aria-labelledby="category-products-title">
            ...
            {state === "loading" ? (
                ...
                <div className="products-panel-state">
                    <div>
                        ...
                        <p>This category exists, but it has no products attached yet.</p>
                    </div>
                </div>
            ) : (
                <>
